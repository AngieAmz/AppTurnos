    ...
    <form id="formCaja" runat="server">
        ...
        <br />
            <div class="select">
                ...
                <asp:label ID="turn" Text="" runat="server"></asp:label>
            </div>
                <br />
                <br />
            <div>
        ...
        <div class="botones">
            ...
            <asp:Button ID="btnRefrescar" CssClass="btn btn-primary btn-dark" runat="server" Text="Refrescar tabla" OnClick="btnRefrescar_Click" />
            <asp:Button ID="btnSiguiente" CssClass="btn btn-primary btn-dark" runat="server" Text="Llamar Siguiente" OnClick="btnSiguiente_Click" />
            <asp:Button ID="btnEliminarTurno" CssClass="btn btn-primary btn-dark" runat="server" Text="Borrar Turno" OnClick="btnEliminarTurno_Click" />
